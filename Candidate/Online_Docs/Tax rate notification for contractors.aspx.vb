...
Partial Class Tax_rate_notification_for_contractors
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If objCandidate IsNot Nothing Then
                ...
                DeclarationName.Text = GetValue(objCandidate, "Name.FirstName") & " " & GetValue(objCandidate, "Name.MiddleName") & " " & GetValue(objCandidate, "Name.LastName")
    ...
    Protected Overrides Sub Render(writer As HtmlTextWriter)
        If convertCrtPageToPdf Then
            ...
            htmlToPdfConverter.BrowserWidth = 1490
