<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DIIControl.ascx.vb" Inherits="DIIControl" %>
...
<section>
    <div class="pad-1" id="dii-form">	
			...
			<h2 class="center">NOTIFICATION OF A NOTIFIABLE INCIDENT</h2>
                <sf:StayinFrontDataSource ID="JobAssignDS1" runat="server" ClassName="JobAssignment" Filter='<%# "Candidate.Username=""" + Session("UserName") + """" %>'
                            ...
                            <sf:KeyColumn Name="Key" />
							        ...
							        <span class="datainfo">
                                        <asp:DropDownList ID="JobBox1" runat="server" DataSourceID="JobAssignDS1" DataValueField="Key" AppendDataBoundItems="true" DataTextField="Name">
				...
				<fieldset>
					...
					<div class="toggle-p">
						...
						<div>
							...
							<div >
						<span class="datainfo inline"><asp:TextBox ID="PhoneAreaBox1" class="phone_l_a"  placeholder="Area" runat="server"></asp:TextBox><asp:TextBox ID="PhoneNumBox1" class="phone_l_n_edit"  placeholder="Number" runat="server"></asp:TextBox></span>
							</div>
						</div>
						<div>
							<label class="desc req" for="mphone-injury-form">Mobile</label>
							<div>
                                <span class="datainfo inline"><asp:TextBox ID="MobileAreaBox1" class="phone_l_a"  placeholder="Area" runat="server"></asp:TextBox><asp:TextBox ID="MobileNumBox1" class="phone_l_n_edit"  placeholder="Number" runat="server"></asp:TextBox></span>
							</div>
						</div>
						<div>
					...
					<fieldset>
						...
						<div class="toggle-p">
							...
							<div>
								...
								<div>
									<span class="datainfo inline"><asp:TextBox ID="AgencyPhoneAreaBox1" class="phone_l_a" placeholder="Area" runat="server"></asp:TextBox><asp:TextBox ID="AgencyPhoneNumBox1" class="phone_l_n_edit"  placeholder="Number" runat="server"></asp:TextBox></span>
								</div>
							</div>	
							<div>
					...
					<fieldset>
						...
						<div>
							...
							<div>
							  <span class="datainfo inline"><asp:TextBox ID="InjPhoneBoxA" class="phone_l_a"  placeholder="Area" runat="server"></asp:TextBox><asp:TextBox ID="InjPhoneBoxN" class="phone_l_n_edit"  placeholder="Number" runat="server"></asp:TextBox></span>
                            </div>
						</div>
						<div>
					...
					<div class="toggle-p">
						<div>
							...
							<div>
                                <asp:TextBox class="inp--width" ID="pcbu_nameBox1" runat="server" Enabled="false">Alpha Personnel Recruitment Ltd</asp:TextBox></div>
						</div>
						<div>
							<label>NZ business number</label>
							<div>
                               <asp:TextBox class="inp--width" ID="pcbu_nzbnBox1" runat="server" Enabled="false" >1,277,480</asp:TextBox>	
							</div>
						</div>
						<div class="editor-label">
							...
							<div>
                                <asp:DropdownList ID="IndustryBox1" Enabled="false"  runat="server"  DataValueField="Key" AppendDataBoundItems="true" DataTextField="Name"   DataSourceID="IndustryDS1"  >
                                    <asp:ListItem Text="" Value="" ></asp:ListItem>
                                </asp:DropdownList>			
							</div>
						</div>
						...
						<div>
							...
							<div>
                                <asp:TextBox class="inp--width" ID="PCBUAddressBox1" runat="server" Enabled="false"  Text="L3, 27 Gillies Ave, Newmarket" ></asp:TextBox>			  
							</div>
						</div>
						<div>
							<label>City</label>
							<div>
                                <asp:TextBox class="inp--width" ID="PCBUCityBox1" runat="server" Enabled="false" Text="Auckland" ></asp:TextBox>			  
							</div>
						</div>
						<div>
							<label>Post Code</label>
							<div>
                                <asp:TextBox class="inp--width" ID="PCBUPostCodeBox1" runat="server" Enabled="false" Text="1149" ></asp:TextBox>			  
							</div>
						</div>
						<div>
							<label class="req">Contact person name</label>
							<div>
                                <asp:TextBox class="inp--width" ID="ContactPersonBox1" runat="server" Enabled="false" Text="Colin Mathieson"></asp:TextBox>			  
							</div>
						</div>
						<div>
							<label>Email</label>
						...
						<div>
							...
							<div>
                                <span class="datainfo inline"><asp:TextBox ID="PCBUMA1" Enabled="false" class="phone_l_a"   placeholder="Area" runat="server"></asp:TextBox><asp:TextBox Enabled="false" ID="PCBUMN1" class="phone_l_n_edit"  placeholder="Number" runat="server" Text="021452324"></asp:TextBox></span>
							</div>
						</div>
						<div>
							<label>PCBU phone no. (land line)</label>
							<div>
                                <span class="datainfo inline"><asp:TextBox ID="PCBUPA1" Enabled="false" class="phone_l_a"  placeholder="Area" runat="server"></asp:TextBox><asp:TextBox Enabled="false" ID="PCBUPN1" class="phone_l_n_edit"   placeholder="Number" runat="server" Text="095242336"></asp:TextBox></span>
							</div>
						</div>
					</div>
					</fieldset>
					...
					<div class="rem">
						...
						<span class="datainfo inline"><asp:TextBox ID="DecPhoneBox1" class="phone_l_n_edit"  placeholder="000 0000000 or 0000000000"  runat="server"></asp:TextBox></span>
