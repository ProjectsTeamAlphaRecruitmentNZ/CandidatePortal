<%@ Control Language="VB" AutoEventWireup="false"  CodeFile="IncidentControl.ascx.vb"   Inherits="IncidentControl" %>
				...
				<fieldset>
					...
					<div class="toggle-p">
						...
						<div class="radioButtonList center">
                            ...
                            <asp:RadioButtonList ID="notifier_type" runat="server" RepeatDirection="Horizontal" DataSourceID="NotifierTypeDS"  CssClass="control control--radio" DataValueField="Value" ></asp:RadioButtonList>
						...
						<div>
							...
							<div >
						<span class="datainfo inline"><asp:TextBox ID="PhoneAreaBox" class="phone_l_a"  placeholder="Area" runat="server"></asp:TextBox><asp:TextBox ID="PhoneNumBox" class="phone_l_n_edit"  placeholder="Number" runat="server"></asp:TextBox></span>
...
<%--							  <input id="phone-injury-form" name="phone-injury-form" type="text" class="field text fn" value="" size="8" tabindex="1">--%>
						...
						<div>
							...
							<div>
                                <span class="datainfo inline"><asp:TextBox ID="MobileAreaBox" class="phone_l_a" placeholder="Area" runat="server"></asp:TextBox><asp:TextBox ID="MobileNumBox" class="phone_l_n_edit"  placeholder="Number" runat="server"></asp:TextBox></span>
							</div>
						</div>
						<div>
					...
					<fieldset>
                        ...
                        <div>
								<label class="desc req" for="place-inc-injury-form">The incident occurred:</label>
								...
								<div>
                                    <asp:DropdownList ID="IncidentPlaceBox"  runat="server" DataSourceID="PlaceOfIncDS"  DataValueField="value" DataTextField="value" >
                                        <asp:ListItem Text="" Value="" ></asp:ListItem>
                                    </asp:DropdownList>
							...
							<div>
								...
								<div>
                                <span class="datainfo inline"><asp:TextBox ID="AgencyPhoneAreaBox" class="phone_l_a"  placeholder="Area" runat="server"></asp:TextBox><asp:TextBox ID="AgencyPhoneNumBox" class="phone_l_n_edit" placeholder="Number" runat="server"></asp:TextBox></span>
								</div>
							</div>	
						</div>
					</fieldset>
					...
					<div class="toggle-p">
						<div>
							...
							<div>
                                <asp:TextBox class="inp--width" ID="pcbu_nameBox" runat="server" Enabled="false">Alpha Personnel Recruitment Ltd</asp:TextBox>
                            </div>
						</div>
						<div>
							<label>NZ business number</label>
							<div>
                               <asp:TextBox class="inp--width" ID="pcbu_nzbnBox" runat="server" Enabled="false" >1,277,480</asp:TextBox>			  
<%--								<input value="1,277,480" maxlength="14" size="14" disabled="disabled" type="text">--%>
						...
						<div class="editor-label">
							...
							<div>
                                <asp:DropdownList ID="IndustryBox"  Enabled="false"  runat="server" DataValueField="Key" DataTextField="Name" AppendDataBoundItems="true" DataSourceID="IndustryDS" >
                                    <asp:ListItem Text="" Value="" ></asp:ListItem>
                                </asp:DropdownList>											
...
<%--								<input value="Human Recources &amp; Recruitment" maxlength="100" size="100" disabled="disabled" type="text">--%>
						...
						<div>
							...
							<div>
                                <asp:TextBox class="inp--width" ID="PCBUAddressBox" runat="server" Enabled="false" Text="L3, 27 Gillies Ave, Newmarket" ></asp:TextBox>			  
						...
						<div>
							<label>City</label>
							<div>
                                <asp:TextBox class="inp--width" ID="PCBUCityBox" runat="server" Enabled="false" Text="Auckland" ></asp:TextBox>			  
						...
						<div>
							...
							<div>
                                <asp:TextBox class="inp--width" ID="PCBUPostCodeBox" runat="server" Enabled="false" Text="1149" ></asp:TextBox>			  
<%--								<input value="1149" maxlength="10" size="10" disabled="disabled" type="text">--%>
						...
						<div>
							...
							<div>
                                <asp:TextBox class="inp--width" ID="ContactPersonBox" runat="server" Enabled="false" Text="Colin Mathieson"></asp:TextBox>			  
						...
						<div>
							...
							<div>
                                <span class="datainfo inline"><asp:TextBox ID="PCBUMA" Enabled="false" class="phone_l_a" placeholder="Area" runat="server"></asp:TextBox><asp:TextBox Enabled="false" ID="PCBUMN" class="phone_l_n_edit"  placeholder="Number" runat="server" Text="021452324"></asp:TextBox></span>
						...
						<div>
							...
							<div>
                                <span class="datainfo inline"><asp:TextBox ID="PCBUPA" Enabled="false" class="phone_l_a" placeholder="Area" runat="server"></asp:TextBox><asp:TextBox Enabled="false" ID="PCBUPN" class="phone_l_n_edit" placeholder="Number" runat="server" Text="095242336"></asp:TextBox></span>
							</div>
						</div>
					</div>
					</fieldset>
...
<%--						<input value="108/47 Hobson Street" maxlength="255" size="255" class="declarationInput" required="true" type="text">--%>
						...
						<span class="datainfo inline"><asp:TextBox ID="DecPhoneBox" class="phone_l_n_edit"  placeholder="000 0000000 or 0000000000"  runat="server"></asp:TextBox></span>
