...
(function($){
            ...
            function () {
                ...
                if (!jQuery('#ptTimeSelectCntr').length) {
                    jQuery("body").append(
                        ...
                        +    '                    <div class="ptTimeSelectLeftPane" style="width: 60%; text-align: center; float: left;" class="">Hour</div>'
                        ...
                        +    '                                <br style="clear: left;" /><div></div>'
                        +    '                            </div>'
                        +    '                            <div class="ptTimeSelectHrAmPmCntr" style="padding-top:5px;">'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);" '
                        +    '                                        style="color:#6A1D44; display: block; margin: 1px; padding: 0.2em; width: 3.09em; font-weight: bold; float: left;">am</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);" '
                        +    '                                        style="color:#6A1D44; display: block; margin: 1px; padding: 0.2em; width: 3.09em; font-weight: bold; float: left;">pm</a>'
                        +    '                                <br style="clear: left;" /><div></div>'
                        +    '                            </div>'
                        +    '                        </div>'
                        +    '                    </div>'
	...
	jQuery(".isPtTimeSelectActive").change();
        this.closeCntr();
    ...
    jQuery.ptTimeSelect.openCntr = function (ele) {
        ...
        style.top           = (style.top + i.outerHeight() - 112);
