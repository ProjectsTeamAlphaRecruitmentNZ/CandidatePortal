...
Partial Class Login
    ...
    Protected Sub Login1_Authenticate(ByVal sender As Object, ByVal e As System.EventArgs)
        'BP 28/1/2017
        ...
        Else
            Session("LoginId") = Login1.UserName
            Response.Redirect("/_ww/ww.dll?webworks/login?UID=" & Login1.UserName & "&PWD=" & Login1.Password & "&OriginalURL=/jobsonline/candidate/default.aspx?userN=" & Login1.UserName, False)
        End If
    End Sub
